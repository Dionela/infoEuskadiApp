...
public class OficinaTurismoActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                ...
                OficinaTurismoActivity.this.mAdapter.getFilter().filter(cs);
    ...
    class DownloadTask extends AsyncTask<Integer, Void, String> {
        ...
        private static final String BASE_URL = "http://opendata.euskadi.eus/contenidos/ds_recursos_turisticos/oficinas_turisticas_euskadi/opendata/oficinas-turismo.json?";
        ...
        protected void onPostExecute(String jsonString) {
            ...
            try {
                ...
                for (int x = 0; x < numRows; x++) {
                    ...
                    final HashMap<String, String> ofiTurismo = new HashMap<String, String>();
                    ofiTurismo.put("nombre", row.getString("documentName"));
                    String tipoTienda =  row.getString("templateType");
                    ofiTurismo.put("tipo",  tipoTienda);
                    String descripcionLimpia  = Html.fromHtml(row.getString("turismDescription")).toString();
                    ofiTurismo.put("descripcion", "" + descripcionLimpia);
                    String direccion = row.getString("address") +", " + row.getString("locality");
                    ofiTurismo.put("direccion",direccion);
                    ofiTurismo.put("telefono", "" + row.getString("phoneNumber"));
                    ofiTurismo.put("web", row.getString("web"));
                    ofiTurismo.put("accesibilidad", "" + row.getString("accesibility"));

                    result.add(ofiTurismo);
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        intent_detalle.setClass(OficinaTurismoActivity.this, DetalleActivityOficinaTurismo.class);
