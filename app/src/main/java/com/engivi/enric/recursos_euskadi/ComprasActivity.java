...
public class ComprasActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                ...
                ComprasActivity.this.mAdapter.getFilter().filter(cs);
    ...
    class DownloadTask extends AsyncTask<Integer, Void, String> {
        ...
        private static final String BASE_URL = "http://opendata.euskadi.eus/contenidos/ds_recursos_turisticos/zonas_de_compras/opendata/compras.json?";
        ...
        protected void onPostExecute(String jsonString) {
            ...
            try {
                ...
                for (int x = 0; x < numRows; x++) {
                    ...
                    final HashMap<String, String> compras = new HashMap<String, String>();
                    compras.put("nombre", row.getString("documentName"));
                    String tipoTienda =  row.getString("templateType");
                    compras.put("tipo",  tipoTienda);
                    String descripcionLimpia  = Html.fromHtml(row.getString("turismDescription")).toString();
                    compras.put("descripcion", "" + descripcionLimpia);
                    String direccion = row.getString("address") +", " + row.getString("locality");
                    compras.put("direccion",direccion);
                    compras.put("telefono", "" + row.getString("phoneNumber"));
                    compras.put("web", row.getString("web"));
                    compras.put("accesibilidad", "" + row.getString("accesibility"));
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        intent_detalle.setClass(ComprasActivity.this, DetalleActivityCompras.class);
