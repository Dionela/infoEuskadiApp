...
public class PatrimonioActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                ...
                PatrimonioActivity.this.mAdapter.getFilter().filter(cs);
    ...
    class DownloadTask extends AsyncTask<Integer, Void, String> {
        ...
        private static final String BASE_URL = "http://opendata.euskadi.eus/contenidos/ds_recursos_turisticos/patrimonio_recursos_culturales/opendata/recursos-culturales.json?";
        ...
        protected void onPostExecute(String jsonString) {
            ...
            try {
                ...
                for (int x = 0; x < numRows; x++) {
                    ...
                    final HashMap<String, String> patrimonio = new HashMap<String, String>();
                    patrimonio.put("nombre", row.getString("documentName"));
                    String tipoTienda =  row.getString("cultureType");
                    patrimonio.put("tipo",  tipoTienda);
                    String descripcionLimpia  = Html.fromHtml(row.getString("turismDescription")).toString();
                    patrimonio.put("descripcion", "" + descripcionLimpia);
                    String direccion = row.getString("address") +", " + row.getString("locality");
                    patrimonio.put("direccion",direccion);
                    patrimonio.put("telefono", "" + row.getString("phoneNumber"));
                    patrimonio.put("web", row.getString("web"));
                    patrimonio.put("accesibilidad", "" + row.getString("accesibility"));

                    result.add(patrimonio);
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        intent_detalle.setClass(PatrimonioActivity.this, DetalleActivityPatrimonio.class);
