...
public class RestaurantesActivity extends ListActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        inputSearch.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                ...
                RestaurantesActivity.this.mAdapter.getFilter().filter(cs);
    ...
    class DownloadTask extends AsyncTask<Integer, Void, String> {
        ...
        private static final String BASE_URL = "http://opendata.euskadi.eus/contenidos/ds_recursos_turisticos/restaurantes_sidrerias_bodegas/opendata/restaurantes.json?";
        ...
        protected void onPostExecute(String jsonString) {
            ...
            try {
                ...
                for (int x = 0; x < numRows; x++) {
                    ...
                    restaurantes.put("nombre", row.getString("documentName"));
                    restaurantes.put("tipo", "" + row.getString("restorationType"));
                    String descripcionLimpia  = Html.fromHtml(row.getString("turismDescription")).toString();
                    restaurantes.put("descripcion", "" + descripcionLimpia);
                    String direccion = row.getString("address") +" - " + row.getString("locality");
                    restaurantes.put("direccion", direccion);
                    restaurantes.put("telefono", "" + row.getString("phoneNumber"));
                    restaurantes.put("web", row.getString("web"));
                    restaurantes.put("accesibilidad", "" + row.getString("accesibility"));

                    result.add(restaurantes);
   ...
   @Override
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        intent_detalle.setClass(RestaurantesActivity.this, DetalleActivityRestaurante.class);
